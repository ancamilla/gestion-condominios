...
import HistorialGastos from "./pages/HistorialGastos"; //corregir
...
import UserGastosPage from "./pages/UserGastosPage";
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/usuario/gastos" element={<UserGastosPage />} />
